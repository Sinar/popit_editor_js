...
import schema from '../schema/post_form.json'
...
export default {
  ...
  methods: {
    submit (e) {
      ...
      var url = '/' + language + '/posts/' + entityId
    ...
    createContact () {
      var entityId = this.$route.params.entity_id
      var url = '/posts/' + entityId + '/contact_details/create'
      this.$router.push(url)
    },
    createLink () {
      var entityId = this.$route.params.entity_id
      var url = '/posts/' + entityId + '/links/create'
      this.$router.push(url)
    },
    listContactDetails () {
      var entityId = this.$route.params.entity_id
      var url = '/posts/' + entityId + '/contact_details/list'
      this.$router.push(url)
    },
    listLinks () {
      var entityId = this.$route.params.entity_id
