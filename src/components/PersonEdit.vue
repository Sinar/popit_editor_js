...
export default {
  ...
  methods: {
    ...
    createContact () {
      var entityId = this.$route.params.entity_id
      var url = '/persons/' + entityId + '/contact_details/create'
      this.$router.push(url)
    },
    createLink () {
      var entityId = this.$route.params.entity_id
      var url = '/persons/' + entityId + '/links/create'
      this.$router.push(url)
    },
    listContactDetails () {
      var entityId = this.$route.params.entity_id
      var url = '/persons/' + entityId + '/contact_details/list'
      this.$router.push(url)
    },
    listLinks () {
      var entityId = this.$route.params.entity_id
      var url = '/persons/' + entityId + '/links/list'
      this.$router.push(url)
    },
    listOtherNames () {
      var entityId = this.$route.params.entity_id
      var url = '/persons/' + entityId + '/other_names/list'
      this.$router.push(url)
    },
    listIdentifiers () {
      var entityId = this.$route.params.entity_id
